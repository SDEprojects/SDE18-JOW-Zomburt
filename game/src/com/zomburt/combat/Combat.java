...
public class Combat {
  ...
  public static void combat(GameCharacter player, Zombie zombie) throws FileNotFoundException, InterruptedException, Exception {
//    GameApp.getInstance().appendToCurActivity("You have encountered a zombie! Prepare yourself");
  ...
  public static void combatCommands(String input, GameCharacter player, Zombie zombie) throws Exception {
  ...
  public static void fight(GameCharacter player, Zombie zombie) throws FileNotFoundException, InterruptedException {
